...
import WardIncidentApprovalPage from "./pages/ward/WardIncidentApprovalPage";
      ...
      <AuthProvider>
        ...
        <BrowserRouter>
          <Routes>
            ...
            <Route path="/ward-incident-approval" element={<ProtectedRoute><WardIncidentApprovalPage /></ProtectedRoute>} />
